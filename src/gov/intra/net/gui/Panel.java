...
public class Panel extends JPanel {
	...
	public Panel(Frame frame) {
		...
		event = new PanelEventHandle(this, frame);
		...
		frSlider.addChangeListener(event);
		...
		fgSlider.addChangeListener(event);
		...
		fbSlider.addChangeListener(event);
		...
		brSlider.addChangeListener(event);
		...
		bgSlider.addChangeListener(event);
		...
		bbSlider.addChangeListener(event);
	...
	public PanelEventHandle getEventHandle() {
		return event;
	}
